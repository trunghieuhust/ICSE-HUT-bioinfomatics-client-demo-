 ...
 *         &lt;element name="activityStatusList" type="{http://service.bio.icse.hust/}activityStatus" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Status {
     ...
     * This is why there is not a <CODE>set</CODE> method for the activityStatusList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getActivityStatusList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
